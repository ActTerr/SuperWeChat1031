...
public class Group implements Serializable{
	...
	private static String mavatarSuffix;
	private Integer mavatarType;
	private String mavatarLastUpdateTime;
	private Integer mgroupId;
	private static String mgroupHxid;
	...
	public static String getMGroupHxid() {
		return mgroupHxid;
	}
	...
	public static String getMAvatarSuffix() {
	...
	public static String getAvatar(){
		String path="http://101.251.196.90:8000/SuperWeChatServerV2.0/downloadAvatar?name_or_hxid="+getMGroupHxid()+"&avatarType=group_icon&m_avatar_suffix="+getMAvatarSuffix()+"&updatetime="+System.currentTimeMillis();
		return path;
	}

	public static String getAvatar(String hxid){
		String path="http://101.251.196.90:8000/SuperWeChatServerV2.0/downloadAvatar?name_or_hxid="+hxid+"&avatarType=group_icon&m_avatar_suffix=.jpg"+"&updatetime="+System.currentTimeMillis();
		return path;
	}
