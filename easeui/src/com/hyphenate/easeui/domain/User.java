...
public class User implements Serializable {
	...
	public String getInitialLetter() {
		if(initialLetter == null){
			EaseUserUtils.setUserInitialLetter(this);
		}
	...
	public String getAvatar() {
		String path = "http://101.251.196.90:8000/SuperWeChatServerV2.0/downloadAvatar?name_or_hxid="+getMUserName()+"&avatarType=user_avatar&m_avatar_suffix=.jpg"+"&updatetime="+getMAvatarLastUpdateTime();
		return path;
	}
}
